DROP TABLE IF EXISTS bi_alefdw_dev.pathway_activity_historical_data;
CREATE TABLE bi_alefdw_dev.pathway_activity_historical_data AS
                 ...
                 WHERE academic_year_is_roll_over_completed
                   AND date_part_year(academic_year_end_date) >=
                       (SELECT max(date_part_year(academic_year_end_date)) - 2
                        FROM bi_alefdw.bi_all_schools_dim_mv) --selecting current and previous 2 academic years
     ),
