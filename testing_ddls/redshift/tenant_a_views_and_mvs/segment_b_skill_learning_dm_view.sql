CREATE OR REPLACE VIEW bi_coredw_dev.pathway_skill_learning_dm_view AS
...
FROM coredw.fact_pathway_skill_learning_progress fslp
         LEFT JOIN (SELECT DISTINCT created_time,
                                    student_dw_id,
                                    skill_dw_id
                    FROM coredw.fact_pathway_skill_learning_progress
