...
create or replace view bi_coredw_dev.interim_checkpoint_nce_ese_view as
with class_db as (select class_dw_id,
     ...
     db as (select fle_student_dw_id,
            ...
            from coredw.fact_learning_experience
                     inner join bi_coredw.bi_student_dim_mv on fle_student_dw_id = student_dw_id
                     inner join bi_coredw.bi_active_schools_dim_mv dsc on student_school_dw_id = dsc.school_dw_id
...
select *
from bi_coredw.interim_checkpint_test_nce_ese_prev_year
