CREATE OR REPLACE VIEW bi_coredw_dev.ip_student_progress_ip_mscl_view AS
...
FROM coredw.dim_class dc
    ...
    AND sc.school_dw_id = ds.student_school_dw_id
         JOIN coredw.dim_content_academic_year dcay
         ...
         JOIN coredw.dim_week dw ON dip.instructional_plan_item_week_dw_id = dw.week_dw_id
         JOIN coredw.dim_term dtrm ON md5(dw.week_term_id) = md5(dtrm.term_id)
         ...
         LEFT JOIN bi_coredw.students_lesson_progress_mv slp
