create or replace view bi_coredw_dev.guardian_login_activity_dm_view as
...
from guardian_info gi
         left join (select distinct fgaa_guardian_dw_id,
                    ...
                    from coredw.fact_guardian_app_activities fgaa
                             inner join bi_coredw.bi_active_schools_dim_mv dt
