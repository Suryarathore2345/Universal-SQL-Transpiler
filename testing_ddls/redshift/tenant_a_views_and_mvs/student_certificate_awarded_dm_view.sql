CREATE OR REPLACE VIEW bi_coredw_dev.student_certificate_awarded_dm_view AS
WITH date_dimension AS (SELECT DISTINCT full_date                 AS local_date,
     ...
     cte_students AS (SELECT DISTINCT ts.local_date,
                                      ...
                                      ts.student_tags,
                                      ts.total_students
                      FROM bi_coredw.total_students as ts
     ...
     cte_teachers AS (SELECT DISTINCT tt.local_date,
                                      ...
                                      tt.school_name,
                                      tt.total_teachers
                      FROM bi_coredw.total_teachers as tt
                               JOIN bi_coredw.bi_active_schools_dim_mv as dsc
