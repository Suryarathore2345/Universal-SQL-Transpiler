CREATE MATERIALIZED VIEW bi_coredw_dev.civil_defense_report_dm_mv AS
WITH
    learning_objective AS (
        ...
        FROM
            coredw.dim_learning_objective dip_dlo
        WHERE
    ...
    program_courses_start AS (
        ...
        FROM
            coredw.dim_course_activity_association
        INNER JOIN
            learning_objective
    ...
    class_total_students_civil_defense AS (
        ...
        INNER JOIN
            coredw.dim_course_activity_association dip
    ...
    completed_lessons AS (
        ...
        FROM
            coredw.fact_learning_experience fle
        INNER JOIN
