create or replace view bi_coredw_dev.student_activity_bw_py_view as
...
from (
         ...
         from coredw.fact_student_activities fsa
         ...
         WHERE trunc(fsta_dw_created_time) BETWEEN TRUNC(SYSDATE) - 15 AND TRUNC(SYSDATE)
         ...
         from coredw.fact_user_login ful
                  join coredw.dim_school ds
         ...
         from coredw.fact_user_heartbeat_hourly_aggregated hbt
                  join coredw.dim_school ds
