DROP MATERIALIZED VIEW bi_coredw_dev.class_total_students_civil_defense_2023_mv;

CREATE MATERIALIZED VIEW bi_coredw_dev.class_total_students_civil_defense_2023_mv AS
...
--            AND class_school_id = 'c97921a8-6555-4c5f-acd2-9487803f2b66' -- test for 1 school
     ...
     civil_defense_lo AS
         (select instructional_plan_curriculum_grade_id,
                 ...
                 lo_code
             from coredw.dim_instructional_plan dip
             INNER JOIN coredw.dim_learning_objective dlo
...
FROM coredw.dim_class dc
         ...
         INNER JOIN coredw.dim_content_repository org
         ...
         INNER JOIN coredw.dim_content_academic_year dcay
                    ON md5(dc.class_content_academic_year) = md5(dcay.content_academic_year_name)
         INNER JOIN coredw.dim_curriculum_grade dcg
