...
-- =============================================================================
CREATE MATERIALIZED VIEW bi_coredw_dev.indonesia_student_login_mv as
(
WITH calendar_year AS (SELECT DISTINCT calendar_year_start_date,
     ...
     login_data AS (SELECT date_trunc('month', login_local_date_time) AS login_month,
                    ...
                    FROM bi_coredw.student_login sl
                             ...
                             INNER JOIN coredw.dim_school dsch
     ...
     student_registrations AS (SELECT DISTINCT str.student_dw_id,
                               ...
                               FROM (SELECT dst.student_dw_id,
                                     ...
                                     FROM coredw.dim_student dst
                                              INNER JOIN coredw.dim_grade dg ON dg.grade_dw_id = dst.student_grade_dw_id
                                              INNER JOIN bi_coredw.bi_all_schools_dim_mv dsc
...
FROM student_month_spine sms
         INNER JOIN coredw.dim_student dst
