CREATE OR REPLACE VIEW bi_coredw_dev.student_heartbeat_activity_military_py_view AS
...
FROM coredw.fact_user_heartbeat_hourly_aggregated ful
         JOIN coredw.dim_school ds
...
and ds.school_organization_dw_id = 29
            and TO_CHAR( convert_timezone('UTC', dt.tenant_timezone, ful.fuhha_created_time), 'HH24:MI:SS') between '07:00:00' and '15:00:00'
