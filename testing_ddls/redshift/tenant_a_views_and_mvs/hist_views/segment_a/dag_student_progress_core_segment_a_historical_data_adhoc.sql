CREATE OR REPLACE VIEW bi_coredw_dev.dag_student_progress_core_military_historical_data_adhoc AS
...
FROM coredw.dim_class_user dcu
         ...
         JOIN bi_coredw.core_class_activity_content_mv cont
         ...
         INNER JOIN bi_coredw.students_lesson_progress_military_historical_data slp
