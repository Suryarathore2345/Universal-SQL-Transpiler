CREATE OR REPLACE VIEW bi_coredw_dev.military_students_kpi_historical AS
WITH term_details AS
    ...
    FROM bi_coredw.student_progress_core_military_historical_data
),
     ...
     login_kpi AS (SELECT school_dw_id,
                   ...
                   FROM (SELECT log.school_dw_id,
                         ...
                         FROM bi_coredw.student_login_military_historical_data log
                                  INNER JOIN
                              term_details t ON
