CREATE OR REPLACE VIEW bi_coredw_dev.tutor_ai_dm_view
AS
WITH date_dimension AS
     ...
     user_context AS (SELECT
                      ...
                      FROM coredw.fact_tutor_user_context ftuc
                               JOIN bi_coredw.bi_active_schools_dim_mv ac
     ...
     tutor_onboarding AS (SELECT fto_user_dw_id,
                          ...
                          FROM coredw.fact_tutor_onboarding
                          WHERE TRUE
     ...
     tutor_session as (SELECT distinct fts_session_id,
                         ...
                         FROM coredw.fact_tutor_session
...
FROM user_context uc
         ...
         LEFT JOIN coredw.fact_tutor_conversation ftc
         ...
         LEFT JOIN coredw.fact_tutor_challenge_question_answer ftcqa
         ...
         LEFT JOIN coredw.fact_tutor_suggestions ftsu
         ...
         LEFT JOIN coredw.fact_tutor_analogous fta
         ...
         LEFT JOIN coredw.fact_tutor_simplification ftsi
         ...
         LEFT JOIN coredw.fact_tutor_translation ftt
