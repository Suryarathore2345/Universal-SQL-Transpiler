create or replace view bi_coredw_dev.learning_experience_dm_view
AS
...
FROM coredw.fact_learning_experience fle
         ...
         JOIN (SELECT fle2.fle_ls_id,
               ...
               FROM coredw.fact_learning_experience fle2
         ...
         LEFT JOIN coredw.dim_class dc ON dc.class_dw_id = fle.fle_class_dw_id
         LEFT JOIN coredw.dim_subject dsu ON dsu.subject_dw_id = fle.fle_subject_dw_id
         LEFT JOIN coredw.dim_term dtr ON fle.fle_term_dw_id = dtr.term_dw_id
         LEFT JOIN coredw.dim_curriculum dcu ON dtr.term_curriculum_id = dcu.curr_id
         LEFT JOIN coredw.dim_curriculum_grade dcg ON fle.fle_curr_grade_dw_id = dcg.curr_grade_dw_id
         LEFT JOIN coredw.dim_curriculum_subject dcs ON fle.fle_curr_subject_dw_id = dcs.curr_subject_dw_id
         LEFT JOIN coredw.dim_learning_path dlp ON fle.fle_lp_dw_id = dlp.learning_path_dw_id
