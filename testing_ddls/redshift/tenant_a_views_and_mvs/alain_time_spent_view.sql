CREATE OR REPLACE VIEW bi_coredw_dev.alain_time_spent_view AS
With max_ay AS (select max(academicyear) max_ay_adt FROM bi_coredw.adt_student_report_detail_dm_view),
     core_courses AS (SELECT fes.local_date,
                      ...
                      FROM bi_coredw.fact_learning_experience_silver_mv fes
     ...
     adt_tests AS (SELECT DATE(fa.fasr_created_date)                AS local_date,
                   ...
                   FROM bi_coredw.adt_student_report_detail_dm_view fa
