CREATE
OR REPLACE VIEW bi_coredw_dev.pathway_nlf_activity_dm_view AS
WITH pathway_student_details AS (SELECT DISTINCT pathway_student_dw_id,
     ...
     skill_learning AS (SELECT skill_learning_student_dw_id,
                        ...
                        FROM bi_coredw.pathway_skill_learning_dm_view psl
                        GROUP BY 1, 2, 3, 4),
