CREATE OR REPLACE VIEW bi_coredw_dev.student_activity_curriculum_view AS
WITH date_dimension as
    ...
    join bi_coredw.bi_active_schools_dim_mv sch
    ...
    LEFT JOIN coredw.dim_course_subject_association csa
