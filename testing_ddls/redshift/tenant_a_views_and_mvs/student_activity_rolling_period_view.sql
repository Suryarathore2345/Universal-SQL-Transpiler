CREATE OR REPLACE VIEW bi_coredw_dev.student_activity_rolling_period_view AS
WITH students_lessons AS (SELECT slp.student_dw_id,
                          ...
                          FROM bi_coredw.students_lesson_progress_mv slp
                                   INNER JOIN bi_coredw.bi_student_dim_mv st
                                   ...
                                   INNER JOIN (SELECT DISTINCT cts.class_dw_id,
                                               ...
                                               WHERE LOWER(cts.class_title) NOT LIKE '%power skills%'
                                                 ...
                                                 AND LOWER(cts.class_gen_subject) != 'core stars') cl
...
FROM bi_coredw.bi_student_dim_mv ds
         INNER JOIN coredw.dim_section dse
