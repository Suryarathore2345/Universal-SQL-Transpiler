CREATE OR REPLACE VIEW bi_coredw_dev.teacher_heartbeat_activity_bw_py_view AS
...
AND trunc(fuhha_dw_created_time) BETWEEN TRUNC(SYSDATE) - 15 AND TRUNC(SYSDATE)
