...
create or replace view bi_coredw_dev.nce_ese_lo_mastery_view AS
with class_db as (select class_dw_id,
     ...
     db as (select fle_student_dw_id,
            ...
            from coredw.fact_learning_experience
                     ...
                     left join coredw.dim_learning_objective on fle_lo_dw_id = lo_dw_id
...
select *
from bi_coredw.nce_ese_lo_mastery_prev_year
