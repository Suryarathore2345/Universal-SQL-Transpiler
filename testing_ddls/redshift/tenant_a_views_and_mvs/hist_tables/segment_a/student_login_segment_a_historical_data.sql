DROP TABLE IF EXISTS bi_coredw_dev.student_login_military_historical_data;
CREATE TABLE bi_coredw_dev.student_login_military_historical_data DISTKEY (school_dw_id)
