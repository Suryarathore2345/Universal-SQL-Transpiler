CREATE OR REPLACE VIEW bi_coredw_dev.total_teachers_py_view AS
WITH date_dimension AS
    ...
    WHERE dt.full_date = trunc(sysdate) - 1         -- Date can be changed based on requirement
),
...
FROM (SELECT DISTINCT *
    ...
    JOIN coredw.dim_teacher dt
        ...
        AND ((teacher_status = 2 AND
            local_date >= trunc(convert_timezone('UTC', ds.tenant_timezone, teacher_created_time))
