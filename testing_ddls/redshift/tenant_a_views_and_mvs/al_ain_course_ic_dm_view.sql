CREATE OR REPLACE VIEW bi_coredw_dev.al_ain_course_ic_dm_view AS
SELECT
    activity_dw_id,
    course_id,
    course_name,
    ...
    fle_score,
    1 AS core_ic_flag
FROM bi_coredw.core_course_classlearning_agg_view
...
SELECT
    ...
    fle_score,
    2 AS core_ic_flag
FROM bi_coredw.core_course_ic_classlearning_agg_view
WHERE upper(school_city_name) = 'AL AIN'
  AND date_part('year', academic_year_start_date) >= 2024
