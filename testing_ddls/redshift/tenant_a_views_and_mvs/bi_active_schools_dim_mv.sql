CREATE MATERIALIZED VIEW bi_coredw_dev.bi_active_schools_dim_mv as
WITH active_academic_year AS
         (SELECT saya.saya_school_id,
          ...
          FROM coredw.dim_school_academic_year_association saya
...
from coredw.dim_school dsc
         ...
         LEFT JOIN coredw.dim_organization org
                   on dsc.school_organization_dw_id = org.organization_dw_id
WHERE school_status = 1
  AND lower(nvl(tag_name, 'NA')) NOT LIKE '%core_test_schools%';
