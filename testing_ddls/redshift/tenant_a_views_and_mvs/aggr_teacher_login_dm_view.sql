CREATE
OR REPLACE VIEW bi_coredw_dev.aggr_teacher_login_activity_dm_view AS
         ...
         with aggr_weekly_total as
                  (select tenant_name,
                   ...
                   from bi_coredw.teacher_login_activity_dm_view
...
from bi_coredw.teacher_login_activity_dm_view dt
