CREATE OR REPLACE VIEW bi_coredw_dev.nce_teacher_login_activity_dm_view as
WITH total_teachers AS (SELECT DISTINCT ds.*,
                        ...
                        FROM bi_coredw.bi_active_schools_dim_mv ds
                                 ...
                                 LEFT JOIN coredw.dim_class_user dcu on dt.teacher_dw_id = dcu.class_user_user_dw_id
                            ...
                            AND class_course_status = 'ACTIVE'
                                 left join coredw.dim_grade dg on dc.class_grade_id = dg.grade_id
