CREATE OR REPLACE VIEW bi_coredw_dev.instructional_plan_dm_view AS
SELECT *
from bi_coredw.ip_instructional_plan_dm_view
UNION ALL
...
FROM bi_coredw.class_total_students_mv cts
         INNER JOIN bi_coredw.core_class_activity_content_mv cont
                   ON cont.class_dw_id = cts.class_dw_id
         LEFT JOIN bi_coredw.students_lesson_progress_mv lp
