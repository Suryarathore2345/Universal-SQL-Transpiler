CREATE OR REPLACE VIEW bi_coredw_dev.teacher_login_activity_dm_view AS
...
FROM bi_coredw.total_teachers tt
         INNER JOIN bi_coredw.bi_all_schools_dim_mv dsc
                   ...
                   AND tt.local_date >= dsc.academic_year_start_date
         LEFT JOIN  bi_coredw.teacher_login_aggregated_mv log
                   ON tt.school_dw_id = log.school_dw_id
                   AND tt.local_date  = log.local_date
         LEFT JOIN bi_coredw.total_students st
