CREATE OR REPLACE VIEW bi_coredw_dev.practice_2021 AS
...
FROM coredw.fact_practice fp
         ...
         JOIN coredw.dim_grade dg ON dst.student_grade_dw_id = dg.grade_dw_id AND dg.grade_status <> 4
         JOIN coredw.dim_tenant dte ON md5(dte.tenant_id) = md5(dsc.tenant_id)
