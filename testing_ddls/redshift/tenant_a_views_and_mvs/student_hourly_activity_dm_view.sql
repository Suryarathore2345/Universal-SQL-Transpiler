CREATE OR REPLACE VIEW bi_coredw_dev.student_hourly_activity_dm_view AS
...
FROM coredw.fact_user_login sl
         ...
         INNER JOIN bi_coredw.total_students ts
         ...
         LEFT JOIN coredw.dim_tag dtg on dtg.tag_association_id = dsc.school_id
