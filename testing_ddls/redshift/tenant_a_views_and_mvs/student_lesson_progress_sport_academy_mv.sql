CREATE MATERIALIZED VIEW bi_coredw_dev.student_lesson_progress_sport_academy_mv
AS
WITH TOTAL_LESSONS_ASSIGNED AS (
    ...
    FROM coredw.dim_class_user d_cu
             INNER JOIN bi_coredw.core_class_activity_content_mv cac
...
from TOTAL_LESSONS_ASSIGNED sla
         JOIN bi_coredw.bi_student_dim_mv dst ON dst.student_dw_id = sla.class_user_user_dw_id
         JOIN coredw.dim_grade dg on dg.grade_dw_id = dst.student_grade_dw_id
