...
create materialized view bi_coredw_dev.structured_lesson_progress_mv
as (
   WITH class_lesson_association AS (SELECT dlo.activity_dw_id       AS assigned_lo_dw_id,
                                     ...
                                     FROM bi_coredw.lo_structure_components_mv AS dlo
                                              ...
                                              INNER JOIN coredw.dim_class dc ON dc.class_material_id = dcr.course_id
   ...
   FROM class_lesson_association clm
            LEFT JOIN bi_coredw.slide_progress_time_spent_mv aspm
