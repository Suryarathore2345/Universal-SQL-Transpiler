...
create materialized view bi_coredw_dev.slide_type_completion_progress_mv as
(
with fact_progress_per_slide as (select date_trunc('week', local_date) AS local_week,
                                 ...
                                 from bi_coredw.fact_slide_progress_mv
     ...
     unique_attempts_per_widget_type as ((SELECT date_trunc('week', local_date)               as local_week,
                                          ...
                                          FROM bi_coredw.fact_slide_progress_mv fsl
...
FROM time_spent_per_slide tsps
         ...
         JOIN coredw.dim_class dc ON dc.class_dw_id = tsps.class_dw_id
