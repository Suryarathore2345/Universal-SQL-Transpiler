CREATE OR REPLACE VIEW eagles_coredw_dev.teacher_absentees_noholiday_weekly as
WITH total_teachers as (
    ...
    FROM bi_coredw.bi_active_schools_dim_mv ds
             ...
             INNER JOIN coredw.dim_teacher dt
...
grant delete, insert, references, select, trigger, update on eagles_coredw.teacher_absentees_noholiday_weekly to group business_intelligence;

grant delete, insert, references, select, trigger, update on eagles_coredw.teacher_absentees_noholiday_weekly to group datascience;

grant delete, insert, references, select, trigger, update on eagles_coredw.teacher_absentees_noholiday_weekly to group tdc;

grant select on eagles_coredw.teacher_absentees_noholiday_weekly to group ro_users;