CREATE OR REPLACE VIEW eagles_coredw_dev.vw_student_onboarding AS
(
WITH total_students AS
     ...
     student_onboarding AS (
        ...
        FROM bi_coredw.student_login sl
                 INNER JOIN coredw.dim_student st
...
grant delete, insert, references, select, trigger, update on eagles_coredw_dev.vw_student_onboarding to group business_intelligence;

grant delete, insert, references, select, trigger, update on eagles_coredw_dev.vw_student_onboarding to group datascience;

grant delete, insert, references, select, trigger, update on eagles_coredw_dev.vw_student_onboarding to group tdc;

grant select on eagles_coredw_dev.vw_student_onboarding to group ro_users;