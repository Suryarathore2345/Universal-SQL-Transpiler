CREATE OR REPLACE VIEW eagles_coredw.vw_teacher_onboarding
as
(
...
grant delete, insert, references, select, trigger, update on eagles_coredw.vw_teacher_onboarding to group business_intelligence;

grant delete, insert, references, select, trigger, update on eagles_coredw.vw_teacher_onboarding to group datascience;

grant delete, insert, references, select, trigger, update on eagles_coredw.vw_teacher_onboarding to group tdc;

grant select on eagles_coredw.vw_teacher_onboarding to group ro_users;