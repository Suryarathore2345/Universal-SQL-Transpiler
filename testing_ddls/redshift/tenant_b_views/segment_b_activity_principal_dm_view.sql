CREATE OR REPLACE VIEW eagles_coredw_dev.pathway_activity_principal_dm_view as
WITH fact_levels_recommended_last AS(
     ...
     AND NOT EXISTS (SELECT 1 FROM coredw.fact_levels_recommended flr2
...
FROM pathway_class_total_students pcts
         ...
         LEFT JOIN coredw.dim_course_activity_container_grade_association cacga
