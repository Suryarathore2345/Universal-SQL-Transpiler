CREATE OR REPLACE VIEW eagles_coredw_dev.pathway_nlf_principal_dm_view AS
WITH pathway_class_total_students AS (SELECT dsc.school_dw_id,
     ...
     students_placed AS (SELECT DISTINCT cr.course_id,
                         ...
                         FROM coredw.fact_pathway_placement fpp
                                  INNER JOIN coredw.dim_course cr
     ...
     adaptive_practice_fact AS (SELECT student_dw_id,
                                ...
                                FROM coredw.fact_adaptive_practice_progress
     ...
     skills_started_fact AS (SELECT slp.student_dw_id,
                             ...
                             FROM coredw.fact_pathway_skill_learning_progress slp
                                      INNER JOIN coredw.dim_course_activity_association caa
     ...
     skills_to_review AS (SELECT student_dw_id,
                          ...
                          WHERE status = 'INTRODUCED'
                            AND NOT EXISTS(SELECT 1
                                           FROM coredw.fact_pathway_skill_gap_tracker sgt2
