CREATE OR REPLACE VIEW eagles_coredw_dev.student_absentees_noholiday_weekly AS
...
grant delete, insert, references, select, trigger, update on eagles_coredw_dev.student_absentees_noholiday_weekly to group business_intelligence;

grant delete, insert, references, select, trigger, update on eagles_coredw_dev.student_absentees_noholiday_weekly to group datascience;

grant delete, insert, references, select, trigger, update on eagles_coredw_dev.student_absentees_noholiday_weekly to group tdc;

grant select on eagles_coredw_dev.student_absentees_noholiday_weekly to group ro_users;