CREATE OR ALTER VIEW ${os_bi_coredw}.student_progress_ip_mscl_view
AS
...
SELECT DISTINCT
    ...
    YEAR(cont.academic_year_end_date) AS content_academic_year_name,
    ...
    ISNULL(
        CASE cont.pacing
            WHEN 'MONTH' THEN MONTH(cont.week_start_date)
