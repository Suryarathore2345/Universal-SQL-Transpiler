CREATE OR ALTER VIEW ${os_bi_coredw}.teacher_activity_bw_py_view
AS
SELECT DISTINCT
    login_date_dw_id,
    teacher_dw_id,
    ...
    CONVERT(DATETIME2, MIN(local_login_time) AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC') AT TIME ZONE 'UTC') AS login_date_time
FROM (
    SELECT DISTINCT
        ...
        CONVERT(DATE, MIN(fta.fta_start_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_date,
        CONVERT(DATETIME2, MIN(fta.fta_start_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_time
    ...
    WHERE CONVERT(DATE, fta.fta_dw_created_time)
    ...
    GROUP BY
        ...
        ds.school_timezone,
        dt.windows_timezone,
        CONVERT(DATE, fta.fta_start_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))
    ...
    SELECT DISTINCT
        ...
        CONVERT(DATE, MIN(ful.ful_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_date,
        CONVERT(DATETIME2, MIN(ful.ful_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_time
    ...
    GROUP BY
        ...
        ds.school_timezone,
        dt.windows_timezone,
        CONVERT(DATE, ful.ful_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))
    ...
    SELECT DISTINCT
        ...
        CONVERT(DATE, MIN(hbt.fuhha_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_date,
        CONVERT(DATETIME2, MIN(hbt.fuhha_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))) AS local_login_time
    ...
    GROUP BY
        ...
        ds.school_timezone,
        dt.windows_timezone,
        CONVERT(DATE, hbt.fuhha_created_time AT TIME ZONE 'UTC' AT TIME ZONE ISNULL(dt.windows_timezone, 'UTC'))
