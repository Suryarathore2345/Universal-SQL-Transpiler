-- ============================================================================
-- Oracle CO (Customer Orders) Schema - Tables, Views, Indexes, Constraints
-- Source: oracle-samples/db-sample-schemas (MIT License)
-- Schema Version: 21 | Release: 08-FEB-2022 | Requires: Oracle 19c+
-- ============================================================================
...
-- Summary of who placed each order and what they bought
...
-- View: store_orders
-- Summary of purchases at each location with GROUPING SETS
...
-- Relational view of JSON review data using JSON_TABLE
...
-- View: product_orders
-- Summary of total sales per product and order status
